(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'kotlinx-coroutines-core', 'kotlin-wrappers-kotlin-react-jsLegacy', 'kotlin-wrappers-kotlin-react-dom-jsLegacy', 'kotlinx-html-js', 'kotlin-css', 'kotlin-wrappers-kotlin-styled-jsLegacy', 'react-player'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('kotlinx-coroutines-core'), require('kotlin-wrappers-kotlin-react-jsLegacy'), require('kotlin-wrappers-kotlin-react-dom-jsLegacy'), require('kotlinx-html-js'), require('kotlin-css'), require('kotlin-wrappers-kotlin-styled-jsLegacy'), require('react-player'));
  else {
    ...
    }root.TodosWeb = factory(typeof TodosWeb === 'undefined' ? {} : TodosWeb, kotlin, this['kotlinx-coroutines-core'], this['kotlin-wrappers-kotlin-react-jsLegacy'], this['kotlin-wrappers-kotlin-react-dom-jsLegacy'], this['kotlinx-html-js'], this['kotlin-css'], this['kotlin-wrappers-kotlin-styled-jsLegacy'], this['react-player']);
  }
}(this, function (_, Kotlin, $module$kotlinx_coroutines_core, $module$kotlin_wrappers_kotlin_react_jsLegacy, $module$kotlin_wrappers_kotlin_react_dom_jsLegacy, $module$kotlinx_html_js, $module$kotlin_css, $module$kotlin_wrappers_kotlin_styled_jsLegacy, $module$react_player) {
  'use strict';
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$App.fetGreeting(this);
          ...
          case 2:
            var greeting = this.result_0;
            return console.log(greeting), Unit;
  ...
  Coroutine$fetGreeting.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  ...
  User.prototype.copy_s4fhmi$ = function (id, userName, displayName) {
    return new User(id === void 0 ? this.id : id, userName === void 0 ? this.userName : userName, displayName === void 0 ? this.displayName : displayName);
  };
  User.prototype.toString = function () {
    return 'User(id=' + Kotlin.toString(this.id) + (', userName=' + Kotlin.toString(this.userName)) + (', displayName=' + Kotlin.toString(this.displayName)) + ')';
  };
  ...
  User.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && (Kotlin.equals(this.id, other.id) && Kotlin.equals(this.userName, other.userName) && Kotlin.equals(this.displayName, other.displayName)))));
  };
